...
function RegisterPage() {
  ...
  return (
    <div className="register-page">
      <Link to="/">
        <img src={`${process.env.PUBLIC_URL}/logo.png`} alt="T&T Camp" className="register_logo" id="logo_Reg" />
      </Link>
        ...
        <div>
          ...
          {showImage && (
            <div className="image-container">
              <img src={`${process.env.PUBLIC_URL}/tntsize.jpg`} alt="T&T Camp" className="toggle_image" />
            </div>
          )}
        </div>
        <input
